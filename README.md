# Maryland Insights - Maryland Business Directory

A directory website for Maryland businesses, built using the Minted Directory Astro template. Provides a markdown-driven, SEO-optimized platform for listing businesses with features like search, tags, sponsored content, and multiple data source integrations.
...
- **Focus**: Maryland business resources and website building tools

## Development Setup

1. Install dependencies: `yarn install`
2. Start dev server: `yarn dev`
3. Build for production: `yarn build` (includes `astro check`)
...
The site is configured for "Maryland Insights" with the following key settings:
- Site title: "Maryland Insights — Build Your Maryland Business Website | Free"
- Base URL: https://marylandinsights.com
- Focus: Helping Maryland small businesses build professional websites with AI-powered tools
- Features: AI-powered content, Maryland-focused SEO, growth tools
